# Changelog Archive — title 7

Older version sections rotated from [testation7html.changelog.md](testation7html.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
