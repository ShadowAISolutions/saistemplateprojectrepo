# Changelog Archive — title 7 (Google Apps Script)

Older version sections rotated from [testation7gs.changelog.md](testation7gs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
