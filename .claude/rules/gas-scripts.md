...
| GasProjectCreator | `googleAppsScripts/GasProjectCreator/gas-project-creator.gs` | `googleAppsScripts/GasProjectCreator/gas-project-creator.config.json` | `live-site-pages/gas-project-creator.html` |
