...
4. **Template version freeze** — never bump `live-site-pages/templates/HtmlAndGasTemplateAutoUpdatehtml.version.txt` — its version must always stay at `|v01.00w|`
...
6. **Template/page propagation** — compare the template file (`live-site-pages/templates/HtmlAndGasTemplateAutoUpdate.html.txt`) against all pages in `live-site-pages/` for structural drift. Flag significant divergences that aren't marked with `PROJECT OVERRIDE` markers (informational only — some drift is expected)
