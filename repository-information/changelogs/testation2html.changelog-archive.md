# Changelog Archive — Tital for testation 2

Older version sections rotated from [testation2html.changelog.md](testation2html.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
