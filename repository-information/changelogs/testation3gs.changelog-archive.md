# Changelog Archive — Test Title 3 (Google Apps Script)

Older version sections rotated from [testation3gs.changelog.md](testation3gs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
