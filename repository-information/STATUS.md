...
| GAS Template | `live-site-pages/gas-template.html` | v01.05w | *(deploy to activate)* | Active |
| GAS Test | `live-site-pages/gas-test.html` | v01.04w | *(deploy to activate)* | Active |
...
| GasTest | `googleAppsScripts/GasTest/gas-test.gs` | `live-site-pages/gas-test.html` | 01.00g | Active |
