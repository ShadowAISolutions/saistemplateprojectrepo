...
- **Dashboard is a developer tool** — unlike `index.html` which is end-user facing, this page is used by the developer during project setup. It generates config and code, not content
