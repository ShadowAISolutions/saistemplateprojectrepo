...
function doGet(e) {
  ...
  // PROJECT START — testauthhtml1 pre-load cached data for live data table
  ...
  var html = `
    <html>
    <head>
      <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"> <!-- PROJECT: testauthhtml1 viewport -->
      ...
      <style>
        ...
        .gas-layer-hidden { display: none !important; } /* PROJECT: testauthhtml1 gas layer toggle */
        ...
        #user-email { position: fixed; top: 35px; right: 22px; z-index: 9999; color: #8b949e; font-size: 11px; font-family: monospace; opacity: 0.8; } /* PROJECT: testauthhtml1 user email display */
        /* PROJECT START — testauthhtml1 Live Data App styles */
        #live-data-app {
    ...
    <body>
      <!-- PROJECT START — testauthhtml1 version and UI elements -->
      <h2 id="version">${escapeHtml(VERSION)}</h2>
      <div id="user-email">${escapeHtml(session.email)}</div>
      <!-- GAS toggle moved to HTML layer (testauthhtml1.html) for full iframe hide/show
      ...
      <!-- PROJECT START — testauthhtml1 Live Data App UI -->
      ...
      <script>
        ...
        // PROJECT START — testauthhtml1 Live Data App UI logic
        (function() {
