...
// truth — this file (testation2.gs) is the ONLY file you need to edit.
//
...
var VERSION = "01.01g";
var TITLE = "Tital for testation 2";                                      // ← gas-template.config.json

// GitHub config — where to pull code from
var GITHUB_OWNER  = "ShadowAISolutions";
var GITHUB_REPO   = "htmltemplateautoupdate";
var GITHUB_BRANCH = "main";
var FILE_PATH     = "googleAppsScripts/Testation2/testation2.gs";

// Apps Script deployment ID (from Deploy → Manage deployments)
var DEPLOYMENT_ID = "AKfycbyTaBYpvIcF64qjZflDwbNBefJ8mooYQ_LYl3Za2rFBdKZ075D8zRsz63sUbcTLGECp";                        // ← gas-template.config.json

// Google Sheets config (optional — for version tracking)
var SPREADSHEET_ID = "1nnNzjARD1kqpuaIuFDHrmKgcaaFrPVKl3AMqUTtfLPo";                      // ← gas-template.config.json
...
var EMBED_PAGE_URL = "https://ShadowAISolutions.github.io/htmltemplateautoupdate/testation2.html";
