...
// truth — this file (testation8.gs) is the ONLY file you need to edit.
//
...
// ── PROJECT CONFIG ────────────────────────────────────────────────
// testation8.config.json (same directory) is the SINGLE SOURCE OF TRUTH for
...
var VERSION = "01.01g";
var TITLE = "test 8";                                // ← testation8.config.json

// GitHub config — where to pull code from
var GITHUB_OWNER  = "ShadowAISolutions";
var GITHUB_REPO   = "htmltemplateautoupdate";
var GITHUB_BRANCH = "main";
var FILE_PATH     = "googleAppsScripts/Testation8/testation8.gs";

// Apps Script deployment ID (from Deploy → Manage deployments)
var DEPLOYMENT_ID = "AKfycbyYVpND1UzIP-8rI_zDasIXQ9QqlTS2Y8RseBs55KZQOuYn9R0l5F1FxCmP4h9akQxV";                        // ← testation8.config.json

// Google Sheets config (optional — for version tracking)
var SPREADSHEET_ID = "1Nusq89frgjs8eWXrK_tYBAcfnscIFxX6sDWIS_F0MlM";                      // ← testation8.config.json
var SHEET_NAME     = "Live_Sheet";                               // ← testation8.config.json

// Sound config (optional — Google Drive file ID for notification sound)
var SOUND_FILE_ID = "1bzVp6wpTHdJ4BRX8gbtDN73soWpmq1kN";                                          // ← testation8.config.json

// Embedding page URL — the GitHub Pages page that iframes this GAS app
var EMBED_PAGE_URL = "https://ShadowAISolutions.github.io/htmltemplateautoupdate/testation8.html";
